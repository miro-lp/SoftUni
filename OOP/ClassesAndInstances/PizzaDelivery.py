class PizzaDelivery:
    ...
    def make_order(self):
        PizzaDelivery.ordered = not PizzaDelivery.ordered
        return f"You've ordered pizza {self.name} prepared with {', '.join([f'{k}: {i}' for k, i in self.ingredients.items()])} and the price will be {self.price}lv."
